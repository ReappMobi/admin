...
const mockPosts: Post[] = [
  {
    ...
    media: {
      remoteUrl:
        'https://www.mercadoeeventos.com.br/wp-content/uploads/2022/11/Centro-Histórico-..jpg',
    },
    comments: [
      {
        id: 101,
...
const mockInstitutions = Array.from(
  new Set(mockPosts.map((post) => post.institution.name)),
);
...
function RouteComponent() {
  ...
  const filteredPosts = posts.filter((post) => {
    ...
    if (
      ...
      post.institution.name !== institutionFilter
    ) {
      return false;
    }
  ...
  return (
    <div className="container mx-auto py-8 px-4 max-w-4xl">
      ...
      <div
        className="mb-6 bg-white rounded-lg p-4 shadow-sm border"
